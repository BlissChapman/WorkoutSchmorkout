...
//    }
    ...
    static func add5TestWorkouts() -> Workout {
        let workout1 = Workout(startTime: NSDate(), duration: 5.0, location: "TEST LOCATION", buddy: "Test Workout", rating: 5, id: 5, next: nil)
        let workout2 = Workout(startTime: NSDate(), duration: 5.0, location: "TEST LOCATION", buddy: "Test Workout", rating: 5, id: 4, next: workout1)
        let workout3 = Workout(startTime: NSDate(), duration: 5.0, location: "TEST LOCATION", buddy: "Test Workout", rating: 5, id: 3, next: workout2)
        let workout4 = Workout(startTime: NSDate(), duration: 5.0, location: "TEST LOCATION", buddy: "Test Workout", rating: 5, id: 2, next: workout3)
        let head = Workout(startTime: NSDate(), duration: 5.0, location: "TEST LOCATION", buddy: "HEAD", rating: 5, id: 1, next: workout4)
